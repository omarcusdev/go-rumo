...
const Navigation = ({ activeView, onViewChange, onOpenSettings }) => {
  ...
  return (
    <div className="navigation-bar">
      ...
      <div className="nav-tabs">
        <button
          className={`nav-tab ${activeView === 'timer' ? 'active' : ''}`}
      ...
      <div className="nav-buttons">
        ...
        <button className="settings-button" onClick={onOpenSettings} title="Configurações">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            <path
